...
const SPECS = [
  { id: 0, label: "Cualquiera", icon: "✨", gradient: true },
  { id: 1, label: "Marta",  initials: "M", color: "#7c3aed" },
  { id: 2, label: "Fátima", initials: "F", color: "#ec4899" },
];
  ...
  return (
    ...
    >
      ...
      <div className="w-[190px] flex-shrink-0 bg-white/50 border-r border-slate-200 p-6 flex flex-col backdrop-blur-xl">
        ...
        {/* Appointment summary */}
        <div className="text-[9.5px] font-black text-slate-400 tracking-[0.2em] uppercase mb-3">Tu cita</div>
        ...
        {/* Services */}
        <div className="text-[9.5px] font-black text-slate-400 tracking-[0.2em] uppercase mt-4 mb-3">Servicios seleccionados</div>
        <div className="flex items-start justify-between gap-1 mb-0.5">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[11.5px] font-bold text-slate-700">Manicura</span>
          </div>
          <span className="text-[10px] font-black text-slate-400 shrink-0 mt-px">45 min</span>
        </div>
        ...
        <div className="p-4 bg-white rounded-2xl border border-slate-100 shadow-inner">
          <div className="text-[9.5px] font-black text-purple-600 tracking-[0.2em] uppercase mb-2 text-center">Resumen</div>
          <div className="flex flex-col items-center gap-0.5">
            <span className="text-[26px] font-black text-slate-900 tracking-tighter leading-none">$25.00</span>
            <span className="text-[9.5px] font-black text-slate-400 uppercase tracking-widest">45 MIN · 1 SERVICIO</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 bg-white/95 p-5 flex flex-col gap-3 min-w-0 overflow-hidden">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="text-[16px] font-bold text-slate-900 tracking-tight">Especialista y fecha</div>
        </div>
        ...
        <div className="w-full p-1.5 bg-purple-500/5 border border-purple-500/10 rounded-2xl flex items-center gap-2">
          <div className="bg-purple-600 px-3 py-1 rounded-xl shadow-lg shadow-purple-500/20 flex items-center justify-center shrink-0">
            <span className="text-[9px] font-black text-white uppercase tracking-[0.2em] leading-none">Agendando:</span>
          </div>
        ...
        <div className="flex gap-3 min-w-0 flex-1">
          ...
          {/* Calendar — rounded-[32px] like real app */}
          <div className="flex-shrink-0 w-[195px]">
            <div className="text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] mb-1.5">Días disponibles</div>
            <div className="bg-white rounded-[24px] border border-slate-200 p-3 shadow-xl">
              <div className="flex items-center justify-between mb-4">
                <div className="text-[12px] font-black text-slate-900 tracking-tight capitalize">Abril 2026</div>
              ...
              {/* Day cells — rounded-full circles like real app */}
        ...
        {/* Footer nav buttons — rounded-2xl font-black uppercase like real app */}
